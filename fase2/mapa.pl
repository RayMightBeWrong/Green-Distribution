mapa([nodo(dewford), nodo(petalburg), nodo(oldale), nodo(littleroot), nodo(slateport), nodo(rustboro), nodo(verdanturf), nodo(fallarbor),
	...
	[aresta(dewford, petalburg, 15, 0.95), aresta(petalburg, oldale, 3, 1.1), aresta(oldale, littleroot, 3, 1.1), aresta(petalburg, rustboro, 10, 0.95), aresta(rustboro, verdanturf, 7, 1),
	...
	aresta(mossdeep, sootopolis, 10, 0.9), aresta(sootopolis, evergrande, 10, 0.8), aresta(slateport, pacifidlog, 20, 0.8), aresta(mossdeep, evergrande, 15, 0.95), aresta(pacifidlog, evergrande, 22, 0.85)]).
