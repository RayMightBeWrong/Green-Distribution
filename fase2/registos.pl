...
estafeta(wally, moto).
estafeta(wally, carro).
estafeta(travis, carro).
estafeta(iris, bicicleta).
estafeta(iris, carro).
...
registo(entrega(may, transporte(bicicleta)), encomenda(c1, slateport, 4, 20, 5), prazo(10/45, 17/11/2021, 10/15, 17/11/2021)).
...
registo(entrega(may, transporte(bicicleta)), encomenda(c4, petalburg, 5, 20, 5), prazo(10/45, 18/11/2021, 10/10, 18/11/2021)).
...
registo(entrega(brendan, transporte(moto)), encomenda(c12, rustboro, 10, 25, 4), prazo(11/30, 17/11/2021, 10/12, 17/11/2021)).
...
registo(entrega(iris, transporte(bicicleta)), encomenda(c15, sootopolis, 2, 20, 5), prazo(19/45, 15/11/2021, 19/44, 15/11/2021)).
...
registo(entrega(iris, transporte(bicicleta)), encomenda(c15, sootopolis, 2, 20, 5), prazo(19/15, 17/11/2021, 19/14, 17/11/2021)).
...
registo(entrega(wally, transporte(moto)), encomenda(c19, fallarbor, 15, 35, 3), prazo(11/30, 16/11/2021, 10/26, 16/11/2021)).
registo(entrega(wally, transporte(moto)), encomenda(c20, littleroot, 10, 50, 4), prazo(16/15, 16/11/2021, 14/28, 16/11/2021)).
registo(entrega(wally, transporte(moto)), encomenda(c21, mauville, 18, 60, 4), prazo(20/45, 16/11/2021, 18/27, 16/11/2021)).
registo(entrega(wally, transporte(carro)), encomenda(c15, sootopolis, 88, 80, 4), prazo(20/45, 17/11/2021, 20/12, 17/11/2021)).
