...
%entrega(nr, estafeta, cliente, meio_de_transporte, volume, date_de_entrega)

g([encomenda(1, c1, 15, 18/11/2021), encomenda(2, c1, 25, 16/11/2021), encomenda(3, c2, 26, 18/11/2021)], [entrega(1, e1, c1, bicicleta, 4, 18/11/2021), entrega(2, e2, c1, moto, 6, 16/11/2021), entrega(3, e1, c2, moto, 7, 18/11/2021)]).
